...
export const MlNodeTip: IMlNodeTip = {
    ...
    'month': 'Месяц. Временной признак - номер месяца в году',
    'week': 'Неделя. Временной признак - номер недели в году',
    'day_of_month': 'Число. Временной признак - число месяца',
    'day_of_week': 'День недели. Временной признак - номер дня недели',
    'hour': 'Час. Временной признак',
    'minute': 'Минута. Временной признак'
};

export const TimeTitle: {[key: string] : string} = {
    'month': 'Месяц',
    'week': 'Неделя',
    'day_of_month': 'Число',
